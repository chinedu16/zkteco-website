...
export default {
  ...
  metaInfo() {
    const title = "ZKTeco";
    const sitename = "ZKTeco West Africa";
    const description =
      "ZKTeco is a globally-renowned provider of security, access control and time management solutions";
    const keywords =
    ...
    return {
      title: title,
      meta: [
        { key: "og:type", property: "og:type", content: keywords },
        {
          key: "og:description",
        ...
        },
        {
          ...
          property: "og:image",
          content:
            "https://zkteco-wa.com/uploads/image/20190611/328670820a77e40543dd19ddd1a0ac2b.png",
        },
