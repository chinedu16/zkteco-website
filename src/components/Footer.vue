      ...
      <div class="">
        <div class="footer-container ">
          <div class="flex align-center justify-center">
            <div
              class="w-full max-w-screen-xxl mt-20 md:mt-0 px-4 py-5 lg:py-5 lg:px-10 flex flex-col-reverse justify-between lg:flex-row"
            >
              <div
    ...
    return {
      navlinks: [
        ...
        },
        {
          title: "Contact Us",
          items: [
            { title: "Project Consultation", path: "contact" },
            { title: "Online Purchase", path: "contact" },
            { title: "Sales Consultation", path: "contact" },
          ],
        },
        {
          title: "Support",
        ...
        },
        {
          ...
          items: [
            { title: "ZKTeco POS Website", path: "https://zktecopos.com/" },
          ],
        },
      ],
    };
